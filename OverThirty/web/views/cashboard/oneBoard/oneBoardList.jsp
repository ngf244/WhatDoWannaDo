		...
		<div id="content" style="border: 2px solid black;">
			...
			<div id="main" style="background: red">
				...
				<div id="buttonList">
					...
					<button>1:1 의뢰하기</button>
				</div>
				
				<hr>
				
				<input type="text" id="manyProject" name="manyOneProject" value="총 000개의 프로젝트" readonly="readonly" >  
				...
				<form id="onelistForm">
					<table id="onelistTable">
						<tr>
							...
							<td>
								<span class="howMoney">예상 금액&nbsp;&nbsp;&nbsp;</span><span class="howMoney">&nbsp;&nbsp;700,000원</span>
							</td>
						</tr>
						<tr>
							<td>
