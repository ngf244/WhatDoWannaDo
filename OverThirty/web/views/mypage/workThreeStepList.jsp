...
<style>
	...
	.workCompleteListTopArea{height: 100px; background: rgb(241, 179, 80); color: white; font-size: 25pt; box-shadow: 2px 2px 5px black;}
	
	#workCompleteListText{font-weight: bolder; margin-top: 25px; padding-left: 40px; padding-right: 30px; display:inline-block;}
